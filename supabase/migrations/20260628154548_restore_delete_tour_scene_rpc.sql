-- Restore the TourScene deletion RPC in environments where the original
-- migration was recorded but the function is missing from public.
...
revoke all on function public.delete_tour_scene(uuid, uuid) from anon;
