...
// Mirrors /api/apps/hyperlocal/manage-subscription. Looks up the user's
// ls_user_packs row, requires a stripe_customer_id, and creates a Stripe
...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    const portalSession = await stripe.billingPortal.sessions.create({
      ...
      return_url: `${origin}/apps/listing-studio/settings?tab=upgrade`,
    });
    ...
    console.error("[listing-studio-manage-subscription] error:", message);
