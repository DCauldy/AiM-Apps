...
import { ThumbsUp, Bookmark, Copy, Check, User, Eye, Pencil, Trash2 } from "lucide-react";
...
export function PromptCard({
  ...
  return (
    <>
      <Card className="group relative hover:shadow-lg transition-shadow cursor-pointer flex flex-col" onClick={() => setIsModalOpen(true)}>
